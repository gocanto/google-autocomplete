...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__googleAutocomplete_vue__ = __webpack_require__(5);
...
/* harmony default export */ exports["default"] = {
	...
	watch: {
		...
		address: function ()
		{
			__WEBPACK_IMPORTED_MODULE_0__Store__["a" /* default */].commit('setAddress', this.address);
		}
	},
		...
		pipeAddress: function ()
		{
			...
			if (place.address_components !== undefined) {
				...
				for (var i = 0; i < place.address_components.length; i++) {
					...
					if (this$1.inputs[input]) {

						data[input] = place.address_components[i][this$1.inputs[input]];
					}
				}

				data = JSON.stringify(data);
				__WEBPACK_IMPORTED_MODULE_0__Store__["a" /* default */].commit('setAddress', JSON.parse(data));
			}
		},
...
new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
	...
	computed:
	{
		...
		{
			return __WEBPACK_IMPORTED_MODULE_1__Store__["a" /* default */].state.sharedAddress;
		}
	},
